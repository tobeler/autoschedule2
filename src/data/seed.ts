// =============================================================
// Seed data — ports `data.js` verbatim into typed form.
// =============================================================
import type {
  JobTypeDef,
  JobTypeKey,
...
import { TODAY, dateKey, addDays } from './helpers';
...
export const PROJECTS: Project[] = [
  { id: 'PRJ-2401', customer: 'cu1', name: 'Whole-home heat pump retrofit', type: 'install', status: 'in_progress', soldDate: '2026-04-22', targetCompletion: '2026-05-25', value: 14995, hubspotDealId: 'DEAL-44218', primaryCrew: 'c1', description: 'Replace oil furnace + AC with 4-ton heat pump. Electrical handoff included.', designNotes: 'ODU goes on east side. Panel sized for new circuit.' },
  { id: 'PRJ-2402', customer: 'cu2', name: 'Heat pump replacement', type: 'install', status: 'in_progress', soldDate: '2026-04-30', targetCompletion: '2026-05-22', value: 16450, hubspotDealId: 'DEAL-44219', primaryCrew: 'c2', description: '5-ton heat pump install. Existing ducts reused.' },
  { id: 'PRJ-2403', customer: 'cu3', name: 'HP install — Cambridge', type: 'install', status: 'in_progress', soldDate: '2026-05-02', targetCompletion: '2026-05-22', value: 15820, hubspotDealId: 'DEAL-44220', primaryCrew: 'c3', description: '4-ton heat pump + thermostat. Customer cares about quiet operation.' },
  { id: 'PRJ-2403b', customer: 'cu3', name: 'Care Plus subscription', type: 'service', status: 'warranty', soldDate: '2025-08-01', targetCompletion: '2026-08-01', value: 240, hubspotDealId: 'DEAL-43101', primaryCrew: 'c4', description: 'Annual tune-up + priority service for original 2024 install.' },
  { id: 'PRJ-2404', customer: 'cu4', name: 'Heat pump water heater', type: 'install', status: 'in_progress', soldDate: '2026-05-08', targetCompletion: '2026-05-22', value: 5995, hubspotDealId: 'DEAL-44225', primaryCrew: 'c9', description: '80gal HPWH. Replaces 50gal gas tank in basement.', designNotes: 'Electrician slot still unfilled — needs assignment.' },
  { id: 'PRJ-2405', customer: 'cu5', name: 'Smart system retrofit', type: 'retrofit', status: 'in_progress', soldDate: '2026-05-12', targetCompletion: '2026-05-21', value: 1490, hubspotDealId: 'DEAL-44229', primaryCrew: 'c7' },
  { id: 'PRJ-2406', customer: 'cu6', name: 'Care Plus subscription', type: 'service', status: 'warranty', soldDate: '2025-05-01', targetCompletion: '2026-05-01', value: 240, hubspotDealId: 'DEAL-42210', primaryCrew: 'c4', description: 'Annual tune-up for 2024 install.' },
  { id: 'PRJ-2407', customer: 'cu7', name: 'Heat pump install (2024)', type: 'install', status: 'warranty', soldDate: '2024-09-15', targetCompletion: '2024-10-30', value: 14200, hubspotDealId: 'DEAL-39812', primaryCrew: 'c4', description: 'Original install. Capacitor replaced under warranty May 21.' },
  { id: 'PRJ-2408', customer: 'cu8', name: 'Heat pump install (2024)', type: 'install', status: 'warranty', soldDate: '2024-08-20', targetCompletion: '2024-10-14', value: 16100, hubspotDealId: 'DEAL-39655', primaryCrew: 'c5', description: 'Returning for noisy fan callback.' },
  { id: 'PRJ-2409', customer: 'cu10', name: 'Commercial HP — café back room', type: 'install', status: 'sold', soldDate: '2026-05-18', targetCompletion: '2026-06-15', value: 24500, hubspotDealId: 'DEAL-44231', primaryCrew: 'c1', description: 'Light commercial HP for café office + storage.', designNotes: 'Ductwork may need re-routing. Walk-through booked.' },
  { id: 'PRJ-2410', customer: 'cu12', name: 'Panel upgrade 100→200A', type: 'install', status: 'sold', soldDate: '2026-05-19', targetCompletion: '2026-06-01', value: 2890, hubspotDealId: 'DEAL-44232', primaryCrew: 'c7' },
  { id: 'PRJ-2411', customer: 'cu9', name: 'Heat pump consultation', type: 'walkthrough', status: 'proposed', soldDate: null, targetCompletion: null, value: null, hubspotDealId: 'DEAL-44240', primaryCrew: 'c10', description: 'Sales walk-through booked for May 21. Quote pending.' },
  { id: 'PRJ-2412', customer: 'cu11', name: 'Whole-home electrification scope', type: 'walkthrough', status: 'proposed', soldDate: null, targetCompletion: null, value: null, hubspotDealId: 'DEAL-44241', primaryCrew: 'c10', description: 'Large estate. Multi-phase project under discussion.' },
];

// ============ REGIONS ============
// Replaced at runtime with HubSpot service_areas after sync.
export const REGIONS: Region[] = [
  { id: 'co', name: 'Colorado', short: 'CO', subs: [
  ...
  { id: 'ny', name: 'New York', short: 'NY', subs: [
    { id: 'ny-all', name: 'New York (statewide)', headcount: 79, crews: 15 },
  ] },
  { id: 'va', name: 'Vancouver', short: 'YVR', subs: [
...
interface MakeJobArgs {
  ...
  extraCrewIds?: string[];
  truckId?: string | null;
  slots?: Array<{ role: RoleKey; level: 'L1' | 'L2' | 'L3'; hours: number; start: number; assignedTo?: string | null; optional?: boolean }>;
  durationHrs?: number;
  notes?: string;
  address: string;
...
function makeJob(args: MakeJobArgs): Job {
  const tpl = JOB_TEMPLATES[args.type as string];
  const rawSlots = args.slots || tpl?.slots || [];
  const slots: JobSlot[] = rawSlots.map((s, i) => ({
    id: args.id + '-s' + i,
    role: s.role,
    level: s.level,
    hours: s.hours,
    ...
    assignedTo: (s as { assignedTo?: string | null }).assignedTo ?? null,
  }));
  return {
    id: args.id,
    type: args.type,
    ...
    date: args.date,
    startHour: args.startHour ?? null,
    durationHrs: args.durationHrs || Math.max(...slots.map((s) => s.start + s.hours), 1),
    crewId: args.crewId || null,
    extraCrewIds: args.extraCrewIds || [],
    truckId: args.truckId || null,
    slots,
    notes: args.notes || '',
    address: args.address,
    hubspotDealId: args.hubspotDealId || null,
...
export const JOBS_SEED: Job[] = [
  // ===== TODAY =====
  makeJob({
    id: 'J-2614', type: 'heatpump', status: 'onsite', customer: 'cu1', address: '142 Elm Ridge Rd · Newton',
  ...
  makeJob({
    id: 'J-2614b', type: 'heatpump', status: 'scheduled', customer: 'cu1', address: '142 Elm Ridge Rd · Newton',
  ...
  makeJob({
    id: 'J-2615', type: 'heatpump', status: 'enroute', customer: 'cu2', address: '87 Sycamore Ave · Brookline',
  ...
  makeJob({
    id: 'J-2611', type: 'heatpump', status: 'scheduled', customer: 'cu3', address: '305 Walnut St · Cambridge',
  ...
  makeJob({
    id: 'J-2622', type: 'water', status: 'onsite', customer: 'cu4', address: '12 Linden Ln · Somerville',
    ...
    slots: [
      ...
      { role: 'electrician', level: 'L1', hours: 2, start: 1, assignedTo: null },
    ],
    hubspotDealId: 'DEAL-44225', price: 5995, notes: 'Electrician slot unfilled — assign before 9a',
  }),
  makeJob({
    id: 'J-2628', type: 'retrofit', status: 'scheduled', customer: 'cu5', address: '498 Beacon St · Boston',
    date: T, startHour: 13.5, crewId: 'c7', truckId: 't7',
    slots: [{ role: 'electrician', level: 'L2', hours: 2, start: 0, assignedTo: 'p15' }],
  ...
  makeJob({
    id: 'J-2640', type: 'walkthrough', status: 'scheduled', customer: 'cu9', address: '54 Pine Hill Rd · Newton',
    date: T, startHour: 11, crewId: 'c10',
    slots: [{ role: 'fsm', level: 'L2', hours: 1.5, start: 0, assignedTo: 'p19' }],
  }),
  makeJob({
    id: 'J-2641', type: 'walkthrough', status: 'scheduled', customer: 'cu11', address: '901 Highland Pl · Brookline',
    date: T, startHour: 14.5, crewId: 'c10',
    slots: [{ role: 'fsm', level: 'L1', hours: 1.5, start: 0, assignedTo: 'p20' }],
  }),
  makeJob({
    id: 'J-2645', type: 'meeting', status: 'scheduled', customer: null, address: 'Jetson HQ · Watertown',
  ...
  // ===== UNSCHEDULED =====
  makeJob({
    id: 'J-2650', type: 'heatpump', status: 'unscheduled', customer: 'cu10', address: '8 Mass Ave · Cambridge',
    date: null, startHour: null,
    hubspotDealId: 'DEAL-44231', price: 24500, notes: 'Light commercial — café back room',
  }),
  makeJob({
    id: 'J-2651', type: 'electrical', status: 'unscheduled', customer: 'cu12', address: '17 Cedar Ct · Medford',
    date: null, startHour: null,
    hubspotDealId: 'DEAL-44232', price: 2890, notes: '100A → 200A panel upgrade',
  }),
  makeJob({
    id: 'J-2652', type: 'callback', status: 'unscheduled', customer: 'cu1', address: '142 Elm Ridge Rd · Newton',
    date: null, startHour: null,
    notes: 'Thermostat pairing issue — same-day request',
  }),
  // ===== TOMORROW =====
  makeJob({
    id: 'J-2660', type: 'heatpump', status: 'scheduled', customer: 'cu5', address: '498 Beacon St · Boston',
  ...
  makeJob({
    id: 'J-2661', type: 'water', status: 'scheduled', customer: 'cu6', address: '23 Hawthorne Ct · Arlington',
  ...
  makeJob({
    id: 'J-2662', type: 'retrofit', status: 'scheduled', customer: 'cu7', address: '76 Beech St · Watertown',
  ...
  // ===== YESTERDAY =====
  makeJob({
    id: 'J-2580', type: 'heatpump', status: 'complete', customer: 'cu9', address: '54 Pine Hill Rd · Newton',
  ...
  // ===== Tp2 / Tp3 / Tp4 =====
  makeJob({
    id: 'J-2670', type: 'heatpump', status: 'scheduled', customer: 'cu2', address: '87 Sycamore Ave · Brookline',
  ...
  makeJob({
    id: 'J-2671', type: 'electrical', status: 'scheduled', customer: 'cu10', address: '8 Mass Ave · Cambridge',
  ...
  makeJob({
    id: 'J-2672', type: 'retrofit', status: 'scheduled', customer: 'cu4', address: '12 Linden Ln · Somerville',
    date: Tp3, startHour: 10, crewId: 'c8', truckId: 't8',
    slots: [{ role: 'electrician', level: 'L2', hours: 2, start: 0, assignedTo: 'p16' }],
  }),
  makeJob({
    id: 'J-2673', type: 'heatpump', status: 'scheduled', customer: 'cu11', address: '901 Highland Pl · Brookline',
  ...
  makeJob({
    id: 'J-2674', type: 'water', status: 'scheduled', customer: 'cu8', address: '210 Pleasant St · Belmont',
...
const _PROJECT_JOB_MAP: Record<string, string[]> = {
...
Object.entries(_PROJECT_JOB_MAP).forEach(([projectId, jobIds]) => {
  jobIds.forEach((jid) => {
    const j = JOBS_SEED.find((x) => x.id === jid);
...
export const CHECKLISTS: Record<string, ChecklistSection[]> = {
  heatpump: [
    ...
    { section: 'Mechanical', items: [
      ...
      { id: 'hp-m2', type: 'multi', label: 'Tests performed', required: true, options: ['Nitrogen pressure test', 'Triple evacuation', 'Vacuum hold (500µ)', 'Line set flush'] },
  ...
  service: [
    { section: 'Diagnosis', items: [
      ...
      { id: 'sv-d2', type: 'multi', label: 'Symptoms observed', required: true, options: ['No heat', 'No cool', 'Short cycling', 'Noisy operation', 'Water leak', 'Thermostat issue', 'Other'] },
...
// ============ CHECKLIST RESPONSES (mock; for completed jobs) ============
export const CHECKLIST_RESPONSES: Record<string, ChecklistResponses> = {
  'J-2580': {
